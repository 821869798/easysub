...
| ID | Status | Item | Acceptance evidence |
|---|---|---|---|
| TEST-01 | [x] | Rust unit/integration suite | 64 tests (61 unit, 2 legacy golden, 1 large corpus) covering external INI fixtures, rule-provider modes, metadata caching and Netch |
